...
// ... Código de la clase Deque ...
	...
	T Front()
	{
		...
		{
			std::cout << "ERROR, Deque vacía. No se puede obtener el elemento frontal." << '\n';
			return T();
		}
	}
	...
	T Back()
	{
		...
		{
			std::cout << "ERROR, Deque vacía. No se puede obtener el elemento final." << '\n';
			return T();
		}
	}
	...
	void Print()
	{
		...
		{
			std::cout << "Deque vacía. No se puede imprimir." << '\n';
		}
	}
